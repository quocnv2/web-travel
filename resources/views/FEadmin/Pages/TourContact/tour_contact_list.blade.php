            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Danh Sách Tư Vấn Tour Riêng</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <td class="action">
                                            ...
                                            <div class="btn-group-dropdown" style="margin-left: 5px;">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item text-inverse pr-10 contact_tour_detail"
                                                    ...
                                                    <a class="dropdown-item" href="javascript:void(0);" title="Delete"
                                                        onclick="openDeleteCustomerModal('{{ $value->name }}', '{{ route('delete_tour_contact', $value->id) }}')">
                                                        <span
...
@stop
@section('view_js')
    @include('FEadmin.Layout.JS.contact_tour_details')
