                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Phản hồi Bài Viết</a></li>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Danh Sách Phản Hồi Bài Viết</h5>
                    </div>
                    <div class="card-body">
...
@stop
@section('view_js')
    @include('FEadmin.Layout.JS.modal_blog_comment_details')
