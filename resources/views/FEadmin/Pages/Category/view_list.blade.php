                                            ...
                                            <div class="btn-group-dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="javascript:void(0);" title="Delete"
                                                        onclick="openDeleteCategoryModal('{{ $value->name }}', '{{ route('delete_category', $value->slug) }}')">
                                                        <span
                                                            style="display: flex; justify-content: flex-start; color: #dc2626;"><i
                                                                class="ti ti-trash me-1"></i> Xóa</span>
                                                    </a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('view_update_category', $value->slug) }}"><span
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Bạn Có Chắc Muốn Xóa Danh Mục <span id="categoryName"></span> Không?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Hủy</button>
                                        <button type="button" class="btn btn-danger"
                                            id="confirmDeleteCategoryBtn">Xóa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('view_js')
    ...
    <script !src="">
        function openDeleteCategoryModal(categoryName, deleteUrl) {
