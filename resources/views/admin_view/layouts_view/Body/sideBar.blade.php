            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/dashboard/index.html">Default</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/dashboard/analytics.html">Analytics</a></li>
                    </ul>
                </li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/demo/layout-2.html">Layouts 2</a></li>
                        <li class="pc-item"><a class="pc-link"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/elements/icon-fontawesome.html">Font Awesome 5</a></li>
                        <li class="pc-item"><a class="pc-link"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item"><a class="pc-link" href="form_floating.html">Form Floating</a></li>
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                ...
                                <li class="pc-item"><a class="pc-link" href="form2_daterangepicker.html">Date Range
                                        Picker</a> </li>
                        ...
                        <li class="pc-item"><a class="pc-link" href="form2_rating.html">Rating</a></li>
                        ...
                        <li class="pc-item"><a class="pc-link" href="form2_switchjs.html">Bootstrap Switch</a></li>
                        <li class="pc-item"><a class="pc-link" href="form2_switchjs.html">Bootstrap Switch</a></li>
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item"><a class="pc-link" href="form2_lay-stickyactionbars.html">Sticky Action
                                bars</a> </li>
                    </ul>
                </li>
                <li class="pc-item pc-hasmenu">
                ...
                <li class="pc-item">
                    <a href="form2_wizard.html" class="pc-link">
                        <span class="pc-micon">
                            <svg class="pc-icon">
                ...
                <li class="pc-item">
                    <a href="form-validation.html" class="pc-link">
                        <span class="pc-micon">
                            <svg class="pc-icon">
                ...
                <li class="pc-item"><a href="image_crop.html" class="pc-link">
                        <span class="pc-micon">
                            <svg class="pc-icon">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/table/tbl_dt-simple.html">Basic initialization</a></li>
                        <li class="pc-item"><a class="pc-link"
                        ...
                        <li class="pc-item"><a class="pc-link"
                                ...
                                Manipulation</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/table/tbl_dt-datetime-sorting.html">Datetime Sorting</a>
                        </li>
                        <li class="pc-item"><a class="pc-link"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/table/dt_advance.html">Advance initialization</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/table/dt_styling.html">Styling</a></li>
                        <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/table/dt_api.html">API</a>
                        </li>
                        <li class="pc-item"><a class="pc-link"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                <li class="pc-item"><a class="pc-link"
                                        href="https://ableproadmin.com/table/dt_ext_basic_buttons.html">Basic button</a>
                                </li>
                                <li class="pc-item"><a class="pc-link"
                                        href="https://ableproadmin.com/table/dt_ext_export_buttons.html">Data export</a>
                                </li>
                            </ul>
                        </li>
                        <li class="pc-item"><a class="pc-link"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/application/ecom_product-add.html">Add New Product</a>
                        </li>
                        <li class="pc-item"><a class="pc-link"
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/application/invoice.html">Dashboard</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/application/invoice-create.html">Create</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/application/invoice-view.html">Details</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/application/invoice-list.html">List</a></li>
                        <li class="pc-item"><a class="pc-link"
                                href="https://ableproadmin.com/application/invoice-edit.html">Edit</a></li>
                    </ul>
                </li>
                <li class="pc-item">
                    ...
                    <ul class="pc-submenu">
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                ...
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        href="https://ableproadmin.com/pages/reset-password-v1.html">reset password</a>
                                </li>
                                <li class="pc-item"><a class="pc-link" target="_blank"
                        ...
                        <li class="pc-item pc-hasmenu">
                            ...
                            <ul class="pc-submenu">
                                ...
                                <li class="pc-item"><a class="pc-link" target="_blank"
                                        href="https://ableproadmin.com/pages/reset-password-v2.html">reset password</a>
                                </li>
                                <li class="pc-item"><a class="pc-link" target="_blank"
                        ...
                        <li class="pc-item">
                            <a href="https://ableproadmin.com/pages/login-v3.html" target="_blank"
                ...
                <li class="pc-item pc-hasmenu">
                    <a href="#!" class="pc-link">
                        ...
                        <span class="pc-mtext">Price</span><span class="pc-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="pc-submenu">
                        <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/pages/price-v1.html">Price
                                1</a></li>
                        <li class="pc-item"><a class="pc-link" href="https://ableproadmin.com/pages/price-v2.html">Price
                                2</a></li>
                    </ul>
                </li>
