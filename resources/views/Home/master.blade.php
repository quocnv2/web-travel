            ...
            @foreach($banner_list as $bannerValue)
                <div class="item">
                    <div class="main-slider-five__image"
                         style="background-image: url({{$bannerValue->imgBanner}});">
                    </div>
                    ...
                    <div class="about-six__image">
                        <div class="about-six__image__one">
                            ...
                            <div class="about-six__experience">
                                <div class="about-six__experience__year">10+</div>
                                <!-- /.about-six__experience__year -->
                                <div class="about-six__experience__text">SỐ NĂM <br> KINH NGHIỆM</div>
                        ...
                        <div class="about-six__inner">
                            <div class="about-six__box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="about-six__box__content">
                                    <h3 class="about-six__box__title">An Toàn Luôn Là Trên Hết</h3>
                            ...
                            <div class="about-six__box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="about-six__box__content">
                                    <h3 class="about-six__box__title">Giá Thấp & Thân Thiện</h3>
                ...
                <div class="col-lg-6">
                    <div class="why-choose-five__content">
                        <div class="sec-title sec-title--two text-left">
                            ...
                            <p class="sec-title__tagline">Làm Để Hiểu Khách Hàng</p><!-- /.sec-title__tagline -->

                            <h2 class="sec-title__title">Tại sao bạn nên chọn <br> công ty chúng tôi</h2>
                            <!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
                        ...
                        <div class="why-choose-five__inner">
                            <div class="why-choose-five__item wow fadeInUp" data-wow-duration="1500ms">
                                <div class="why-choose-five__item__left">
                                    ...
                                    <h3 class="why-choose-five__item__title">An Toàn</h3>
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="offer-three__content">
                        <div class="sec-title sec-title--two text-left">
                            ...
                            <p class="sec-title__tagline">Chương Trình Đặc Biệt</p><!-- /.sec-title__tagline -->

                            <h2 class="sec-title__title">Nhận Giảm Giá Tới 50% Tại <br> Điểm Đến Yêu Thích Của Bạn</h2>
                            <!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
    ...
    <section class="testimonial-four section-space">
        ...
        <div class="container">
            <div class="sec-title sec-title--two text-center">
                ...
                <p class="sec-title__tagline">Lời Chứng Thực Của Khách Hàng</p><!-- /.sec-title__tagline -->

                <h2 class="sec-title__title">Mọi Người Nói Gì Về Chúng Tôi</h2><!-- /.sec-title__title -->
            </div><!-- /.sec-title -->
            <!-- /.sec-title -->
            <div
                ...
                <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                    <div class="testimonials-card-four">
                        ...
                        <div class="testimonials-card-four__identity">
                            ...
                            <p class="testimonials-card-four__identity__designation">Khách Hàng</p>
                ...
                <div class="row gutter-y-40">
                    <div class="col-xl-3 col-md-6 wow animated fadeInUp" data-wow-delay="0s"
                        ...
                        <div class="footer-widget footer-widget--about">
                            <h2 class="footer-widget__title">Về Chúng Tôi</h2><!-- /.footer-widget__title -->
                    ...
                    <div class="col-xl-3 col-md-3 wow animated fadeInUp" data-wow-delay="0.1s"
                        ...
                        <div class="footer-widget footer-widget--links footer-widget--links-1">
                            <h2 class="footer-widget__title">Liên Kết Hữu Ích</h2><!-- /.footer-widget__title -->
                    ...
                    <div class="col-xl-2 col-md-3 wow animated fadeInUp" data-wow-delay="0.2s"
                        ...
                        <div class="footer-widget footer-widget--links footer-widget--links-2">
                            <h2 class="footer-widget__title">Công Ty</h2><!-- /.footer-widget__title -->
                            <ul class="footer-widget__links">
                    ...
                    <div class="col-xl-4 col-md-6 wow animated fadeInUp" data-wow-delay="0.3s"
                        ...
                        <div class="footer-widget footer-widget--gallery">
                            <h2 class="footer-widget__title">Phòng Trưng Bày Của Chúng Tôi</h2><!-- /.footer-widget__title -->
