<section class="cta-one right-menu-moblie">
    <div class="container">
        <div class="cta-one__wrapper" style="background-image: url({{url('assets') }}/trevlo/images/shapes/cta-bg-1.png);">
            ...
            <div class="cta-one__shape-two"><img src="{{url('assets') }}/trevlo/images/shapes/cta-1-shape-2.png" alt="trevlo"></div>
            <div class="cta-one__shape-three"><img src="{{url('assets') }}/trevlo/images/shapes/cta-1-shape-3.png" alt="trevlo"></div>
            <div class="row">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                    <div class="cta-one__content">
                        <h5 class="cta-one__sub-title">Ưu đãi đặc biệt dành cho bạn</h5>
                        <h3 class="cta-one__title">Bắt đầu hành trình của bạn chỉ bằng một cú nhấp chuột</h3>
                        <a href="contact.html" class="trevlo-btn trevlo-btn--primary"><span>Đăng Ký Tư Vấn</span></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 wow fadeInRight" data-wow-delay="200ms">
                    <div class="cta-one__thumb">
                        <img src="{{url('assets') }}/trevlo/images/resources/cta-1-1.jpg" alt="trevlo" />
                    </div><!-- /.cta-thumb-one -->
                </div>
            </div>
            <div class="cta-one__counter" style="background-image: url({{url('assets') }}/trevlo/images/shapes/cta-1-shape-offer.png);">
                <div class="cta-one__counter__number count-box"><span class="count-text" data-stop="10" data-speed="1500"></span>%</div><!-- /.counter__number -->
                <p class="cta-one__counter__title">Giảm giá</p><!-- /.counter__title -->
            </div><!-- /.counter__offer -->
