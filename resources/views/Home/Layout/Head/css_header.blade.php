...
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/jquery-ui/jquery-ui.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/jarallax/jarallax.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/jquery-magnific-popup/jquery.magnific-popup.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/nouislider/nouislider.min.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/nouislider/nouislider.pips.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/tiny-slider/tiny-slider.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/trevlo-icons/style.css" />
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/vendors/trevlo-one-icons/style.css" />
...
<link rel="stylesheet" href="{{ url('assets') }}/trevlo/css/color-2.css" />
