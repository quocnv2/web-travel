...
@section('view')
    <section class="page-header">
        ...
        <!-- /.page-header__bg -->
        <div class="container">
            <h2 class="page-header__title wow animated fadeInLeft" data-wow-delay="0s" data-wow-duration="1500ms">Đăng Ký Thiết Kế Tour Riêng</h2>
            <div class="page-header__breadcrumb-box">
                <ul class="trevlo-breadcrumb">
                    <li><a href="{{ route('home') }}">Trang Chủ</a></li>
                    <li>Đăng Ký Thiết Kế Tour Riêng</li>
                ...
                <div class="col-xl-8">
                    <form class="contact-page__form form-one row gutter-20" method="POST" id="formReset">
                        <div class="sec-title" style="margin: 50px 0px 0px 0px;">
                            <p class="sec-title__tagline">Đăng Ký Thiết Kế Tour Riêng</p><!-- /.sec-title__tagline -->
