                        ...
                        <form action="#"
                            ...
                            <ul class="sidebar-blog__categories ">
                                @foreach ($categories as $cat)
                                    <li><a href="{{ route('listTour_Category', $cat->slug) }}">{{ $cat->name }}</a></li>
                                @endforeach
                            ...
                            <ul class="tour-listing-sidebar-post">
                                @foreach ($tourlist as $valueNewtour)
                                    @php
                                        ...
                                        $imageArray= json_decode($valueNewtour->imageArray, true);
                                        $videoArray= json_decode($valueNewtour->videoArray, true);
                                    @endphp
                                    ...
                                    <div class="tour-listing-sidebar-post__content">
                                        <p class="tour-listing-sidebar-post__price">{{ number_format($valueNewtour->price, 0, ',', '.') }}vnđ</p>
                                        <h5 class="tour-listing-sidebar-post__link"><a
                                                href="tour-listing-details-right.html">{{$valueNewtour->name}}</a></h5>
                        ...
                        <div class="col-12 wow animated fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                            <div class="tour-listing-three__card tour-listing__card">
                                <a href="tour-listing-details-right.html"
                                    ...
                                    <div class="tour-listing-three__card-image-overlay tour-listing__card-image-overlay">
                                    ...
                                    <div class="tour-listing-three__card-inner-content tour-listing__card-inner-content">
                                        ...
                                        <div class="tour-listing__card-bottom">
                                            ...
                                            <div class="tour-listing__card-bottom-right">
                                                <h4 class="tour-listing__card-price">{{ number_format($valueTour->price, 0, ',', '.') }}vnđ</h4>
