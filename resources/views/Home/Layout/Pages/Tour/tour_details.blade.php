...
@section('view')
                    ...
                    <div class="col-xl-8">
                                        ...
                                        <div class="tour-listing-three__card tour-listing__card">
                                            ...
                                            <div class="tour-listing-three__card-content tour-listing__card-content">
                                                <h3 class="tour-listing-three__card-title tour-listing__card-title">
                                                    <a href="{{ route('detailTour', $tourpc->slug) }}">(
                                                        {{ 'Mã Tour : ' . ' ' . $tourpc->code }} )
                                                        {{ $tourpc->name }}</a>
                                                </h3>
                                                <div
                        ...
                        @if ($tourpc->count() > 3)
                            <div class="tour-listing__load-more">
                                <div class="form-one__btn-box">
                                    <a href="#" class="form-one__btn trevlo-btn trevlo-btn--base">
                                        <span>Xem Thêm</span></a>
                                </div>
                            </div>
                        @endif
    ...
    <div class="modal fade modal-lg" id="commentModal" tabindex="-1" role="dialog"
    ...
    <div id="no__tour_comments_modal mocal-xl" class="modal fade" tabindex="-1" role="dialog"
