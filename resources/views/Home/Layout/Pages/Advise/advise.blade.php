...
@section('view')
            ...
            <div class="row">
                <div class="col-xl-4">
                    <aside class="tour-listing-sidebar">
                        <div
                            class="tour-listing-sidebar__form tour-listing-sidebar__item wow animated fadeInUp left-controller-tour-new"
                        ...
                        <div
                            class="tour-listing-sidebar__post-box tour-listing-sidebar__item wow animated fadeInUp left-controller-tour-new"
                            data-wow-delay="0.1s" data-wow-duration="1500ms">
                        ...
                        <div
                            class="tour-listing-sidebar__post-box tour-listing-sidebar__item wow animated fadeInUp left-controller-tour-new"
                            data-wow-delay="0.1s" data-wow-duration="1500ms">
                            <h3 class="tour-listing-sidebar__post-title tour-listing-sidebar__post-title">Khách
                                Sạn </h3>
                            <ul class="tour-listing-sidebar-post">
                ...
                <div class="col-xl-8">
                    <form class="contact-page__form form-one row gutter-20" method="POST" id="formReset">
                        ...
                        <div class="col-md-6 wow animated fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">
                            <div class="form-one__group">
                                <select name="installment_percentage" id="installment_percentage" class="form-one__input">
                                    <option value="">Chọn phần trăm trả góp</option>
                        ...
                        <div class="col-md-6 wow animated fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">
                            <div class="form-one__group">
                                <select name="number_of_installment_months" id="number_of_installment_months"
                                        class="form-one__input">
                                    <option value="">Chọn số tháng trả góp</option>
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="trevlo-accrodion faq-page__faq" data-grp-name="faq-page__faq">
                                    ...
                                    <div class="accrodion wow animated fadeInUp" data-wow-delay="0.6s"
                                        ...
                                        <div class="accrodion-content" style="display: none;">
                                            <div class="inner">
                                                <p>Hãy tin tưởng vào sự chất lượng và dịch vụ tuyệt vời của chúng tôi,
                                                    được chứng
    ...
    <script>
        $(document).ready(function() {
            $('#installment_percentage').on('change', function() {
                var selectedValue = $(this).val(); // Lấy giá trị đã chọn

                if (selectedValue === '100') {
                    // Disable element khi chọn 100%
                    $('#number_of_installment_months').prop('disabled', true);
                } else {
                    // Enable lại nếu không phải chọn 100%
                    $('#number_of_installment_months').prop('disabled', false);
                }
            });
        });
    </script>
